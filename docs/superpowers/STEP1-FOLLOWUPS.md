...
From the per-task + final whole-branch reviews. None block merge of Step 1; bundle
the view-polish ones into one small PR, and track the latent risks against Step 2.
