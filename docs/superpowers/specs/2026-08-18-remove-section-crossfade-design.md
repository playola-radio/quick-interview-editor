...
> **Superseded (2026-08-20):** PR 1 below shipped; PRs 2–4 are replaced by the
> 5-PR completion sequence in
> `docs/superpowers/plans/2026-08-20-remove-section-crossfade-completion.md`
> (adds: always-edited transport coordinates, playlist scheduler contract,
> continuous `curveAmount` + `centerOffsetSamples` fade model, seam selection +
