...
FOCUSED_INTRO_DISCOVERY_VERSION = "configured-v5"
QUALIFIED_INTRO_DISCOVERY_VERSIONS = frozenset((QUALIFIED_INTRO_DISCOVERY_VERSION, FOCUSED_INTRO_DISCOVERY_VERSION))
BROAD_INTRO_DISCOVERY_VERSIONS = QUALIFIED_INTRO_DISCOVERY_VERSIONS | {BROAD_INTRO_DISCOVERY_VERSION}
